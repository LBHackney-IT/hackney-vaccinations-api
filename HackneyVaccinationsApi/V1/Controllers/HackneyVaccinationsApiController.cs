...
namespace HackneyVaccinationsApi.V1.Controllers
{
    ...
    public class HackneyVaccinationsApiController : BaseController
    {
        private readonly IGetAllUseCase _getAllUseCase;
        private readonly IGetByIdUseCase _getByIdUseCase;
        public HackneyVaccinationsApiController(IGetAllUseCase getAllUseCase, IGetByIdUseCase getByIdUseCase)
        {
